...
local highlights = {
    ...
    codewars_lang_python = { fg = "#3572A5" },
    ...
    codewars_lang_c = { fg = "#555555" },
    codewars_lang_csharp = { fg = "#68217A" },
    codewars_lang_go = { fg = "#00ADD8" },
    codewars_lang_rust = { fg = "#DEA584" },
    codewars_lang_haskell = { fg = "#5D4F85" },
    codewars_lang_clojure = { fg = "#63B132" },
    codewars_lang_elixir = { fg = "#6E4A7E" },
    codewars_lang_swift = { fg = "#F05138" },
    codewars_lang_kotlin = { fg = "#7F52FF" },
    codewars_lang_scala = { fg = "#DC322F" },
    codewars_lang_php = { fg = "#777BB4" },
    codewars_lang_shell = { fg = "#89E051" },
    codewars_lang_lua = { fg = "#000080" },
    codewars_lang_coffeescript = { fg = "#244776" },
    codewars_lang_sql = { fg = "#E38C00" },
    codewars_lang_dart = { fg = "#00B4AB" },
    codewars_lang_r = { fg = "#276DC3" },
    codewars_lang_nim = { fg = "#FFE953" },
    codewars_lang_crystal = { fg = "#000100" },
