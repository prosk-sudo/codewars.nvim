...
- **Save a kumite as a draft** (`:CW kumite save`): saves the current workspace to your codewars.com account — a new draft the first time (a forked/new kumite), an in-place update every time after. Signed-out saves prompt to sign in and then resume. Publishing and a My Drafts list arrive in a later phase.
